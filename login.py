...
# image2 = image2.resize((700,650), Image.ANTIALIAS)
...
title=tk.Label(root, text="Student Login Here", font=("Times new roman", 25, "bold","italic"),bd=5,bg="black",fg="white")
title.place(x=100,y=50,width=300)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=0,y=150)
...
btn_reg=tk.Button(Login_frame,text="SIGN-UP",command=registration,width=15,font=("Times new roman", 14, "bold"),bg="blue",fg="white")
