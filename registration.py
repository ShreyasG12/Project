...
def insert():
    ...
    if (fname.isdigit() or (fname == "")):
        ...
        with conn:
            ...
            conn.commit()
            db.close()
            ms.showinfo('Success!', 'Student Account Created Successfully !')
...
l1 = tk.Label(window, text="Student Information Form", font=("Times new roman", 25, "bold"), bg="#192841", fg="white")
l1.place(x=190, y=50)
